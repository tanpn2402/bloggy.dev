                ...
                return this.Promise.resolve()
                    ...
                    .then(() => this.Promise.all([
                        ...
                        return this.transformDocuments(ctx, params, res[0])
                            .then(docs => {
                                console.log(docs)
                                return this.transformResult(ctx, docs, ctx.meta.user);
                            })
                            .then(r => {
    ...
    methods: {
        ...
        transformResult(ctx, entities, user) {
            if (Array.isArray(entities)) {
                return this.Promise.resolve()
                    .then(() => {
                        entities.forEach(item => this.transformEntity(ctx, item, user))
                        return entities;
                    })
        ...
        transformEntity(ctx, entity, loggedInUser) {
            ...
            return this.Promise.resolve(entity)
                .then(entity => {
                    ...
                    entity.author.image = entity.author.image || "/assets/images/default/smiley-cyrus.jpg";
                    console.log('entity', entity)
                    return entity;
                });
